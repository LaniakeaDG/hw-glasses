...
class RecognitionCompleteDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_recognition_complete, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(position: String): RecognitionCompleteDialogFragment {
            return RecognitionCompleteDialogFragment().apply {
