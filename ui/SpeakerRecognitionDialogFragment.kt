...
class SpeakerRecognitionDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_speaker_recognition, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(position: String): SpeakerRecognitionDialogFragment {
            return SpeakerRecognitionDialogFragment().apply {
